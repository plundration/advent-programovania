...
func pocet_konarov(otazka string) int {
	...
	fmt.Println("Koľko vätiev má vetva číslo", otazka)
	fmt.Scan(&n)

	// samotná vetva má n konárov
	count := n

	// pripočítame počet konárov každej vätvy
	for i := 0; i < n; i++ {
		// x += y znamená zväčšiť x o y
		// Sprint je ako print, ale vytvorí string
		count += pocet_konarov(fmt.Sprint(i, " vätvy číslo ", otazka))
	}
...
func main() {
	fmt.Println("Strom má", pocet_konarov("0?"), "vätiev!")
}
```
...
```
Koľko vätiev má vetva číslo 0?
3
Koľko vätiev má vetva číslo 0 vätvy číslo 0?
1
Koľko vätiev má vetva číslo 0 vätvy číslo 0 vätvy číslo 0?
0
Koľko vätiev má vetva číslo 1 vätvy číslo 0?
3
Koľko vätiev má vetva číslo 0 vätvy číslo 1 vätvy číslo 0?
1
Koľko vätiev má vetva číslo 0 vätvy číslo 0 vätvy číslo 1 vätvy číslo 0?
0
Koľko vätiev má vetva číslo 1 vätvy číslo 1 vätvy číslo 0?
0
Koľko vätiev má vetva číslo 2 vätvy číslo 1 vätvy číslo 0?
1
Koľko vätiev má vetva číslo 0 vätvy číslo 2 vätvy číslo 1 vätvy číslo 0?
0
Koľko vätiev má vetva číslo 2 vätvy číslo 0?
2
Koľko vätiev má vetva číslo 0 vätvy číslo 2 vätvy číslo 0?
1
Koľko vätiev má vetva číslo 0 vätvy číslo 0 vätvy číslo 2 vätvy číslo 0?
3
Koľko vätiev má vetva číslo 0 vätvy číslo 0 vätvy číslo 0 vätvy číslo 2 vätvy číslo 0?
1
Koľko vätiev má vetva číslo 0 vätvy číslo 0 vätvy číslo 0 vätvy číslo 0 vätvy číslo 2 vätvy číslo 0?
0
Koľko vätiev má vetva číslo 1 vätvy číslo 0 vätvy číslo 0 vätvy číslo 2 vätvy číslo 0?
0
Koľko vätiev má vetva číslo 2 vätvy číslo 0 vätvy číslo 0 vätvy číslo 2 vätvy číslo 0?
0
Koľko vätiev má vetva číslo 1 vätvy číslo 2 vätvy číslo 0?
0
Strom má 16 vätiev!
```

Strom má vskutku 16 vätiev. Náš program je geniálny! Skúste si ho prejsť
