...
vytvoriť. Poznáme *statické zoznamy*, lepšie nazvané *arrays*, ktoré obsahujú pevný počet
prvkov. O chvíľu sa ale pozrieme aj na *slice*, ktorého počet prvkov sa dá
zmeniť.

## Statické zoznamy

Dajme tomu, že chceme vytvoriť zoznam troch prvkov. Vytvoríme ho nasledovným syntaxom:
...
Ak chceme pristúpiť k n-tému prvku zoznamu, využijeme syntax hranatých zátvoriek:
...
func main() {
	const n = 33          // konštanta (zoznam musí mať konštantný rozmer)
